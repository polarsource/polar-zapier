...
const TRIGGER_DEFINITIONS = [
  ...
  },
  {
    ...
    description: 'Triggers when a checkout session expires.',
    noun: 'Checkout',
    sample: loadSample('checkout'),
  },
  {
  ...
  },
  {
    ...
    description: 'Triggers when a subscription cancellation is revoked.',
    noun: 'Subscription',
    sample: loadSample('subscription'),
  },
  {
    ...
    description: 'Triggers when a subscription payment fails and becomes past due.',
    noun: 'Subscription',
    sample: loadSample('subscription'),
  },
];
